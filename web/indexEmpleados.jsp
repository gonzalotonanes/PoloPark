                            ...
                            <div class="row">
                                <div class="col-lg-9 col-md-8">
                                    ...
                                    <div class="container align-items-center text-center contenedorBotones">
                                        <button onclick="nuevoEmpleado()" type="button" class="btn btn-success">Nuevo</button>
                                        <button onclick="listarEmpleados()" type="button" class="btn btn-success">Listar</button>
                                    </div>
                                </div>
